...
static t_ft_bst_static_node	*new_node(const t_ft_bst_static_context_r *context)
{
...
static t_err	put(
	const t_ft_bst_static_context_r *context,
...
{
	const t_ft_bst_static_context_r	context = {self, key, value};
